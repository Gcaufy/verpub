...
exports = module.exports = class VerPub {
  constructor(opt = {}) {
    ...
    this.opt = deepmerge({}, DEFAULT_OPT, configOpt, opt);
    ...
    return this.executer
      ...
      .then(() => {
        return this.executer.githash().then(hash => {
          ...
          this.logger.info('Writing ' + this.opt.usePkg);
          changedFiles.push(this.opt.usePkg);
          return writeJsonFile(
            path.join(process.cwd(), this.opt.usePkg),
            Object.assign({}, pkg, {
